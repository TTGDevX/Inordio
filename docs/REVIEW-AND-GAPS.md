...
- **Email delivery + templates** ✅ — quotes/invoices/reminders send via Mailables; **per-tenant SMTP** configurable; **user-editable subject/body templates** with safe `{{ token }}` substitution at `settings/templates` (June 2026).
